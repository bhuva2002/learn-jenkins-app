        ...
        stage('Deploy Staging') {
            ...
            steps {
                sh '''
                    ...
                    node_modules/.bin/netlify deploy --dir=build --json > deploy_stage_output.json
                '''
                script {
                    env.STAGING_URL = sh(script: "node_modules/.bin/node-jq -r '.deploy_url' deploy_stage_output.json", returnStdout: true)
                }
            }
        }
